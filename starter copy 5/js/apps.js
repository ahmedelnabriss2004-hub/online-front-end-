...
btn.onclick = (e) => {
    ...
    let item = ` <div class="child">
                        ...
                        <div> <label for="c${counter}id">رقم الهوية</label>
                            <input type="number" name="c${counter}id" id="c${counter}id">
                        </div>

                        <div>
                            <label for="c${counter}age">السن</label>
                            <input type="number" name="c${counter}age" id="c${counter}age">
                        </div>
